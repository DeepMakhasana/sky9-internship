...
$(document).ready(function () {
    let products;
    let cartProducts = getLocalStorage("cart-product");
    ...
    // ---------------------------------------------------------------------------
    // add to cart ------------------------------------------------------------------------------------
    function appendCartProducts(products) {
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between align-item-center my-3">
                        <div class="input-group">
                          ...
                          <button data-temp=${product.id} class="removeItem btn btn-outline-primary" id="basic-addon1">remove</button>
                      </div>
                      <p class="card-text"><small class="text-body-secondary">${product.quantity} pice price is $${product.quantity * product.price}</small></p>
                    </div>
                  </div>
                </div>
              </div>`);
    ...
    function incrementCardProductQuantity(index) {
    ...
    function decrementCardProductQuantity(index) {
